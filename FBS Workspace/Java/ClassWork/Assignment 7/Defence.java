...
abstract class Defence {
	...
	public String toString() {
	    return "Name of Head: " + this.nameOfHead +
	           "\nNumber of Troops: " + this.noOfTroops +
	           "\nBudget: " + this.budget +
	           "\nNumber of Departments: " + this.noOfDept +
	           "\nNumber of Vehicles: " + this.noOfVehicle +
	           "\nHeadquarters Location: " + this.locationHeadQuarters +
	           "\nCountry Name: " + this.countryName +
	           "\nManpower Count: " + this.manPowerCount +
	           "\nNumber of Missions Performed: " + this.noOfMissionsPerformed +
	           "\nNumber of Casualties: " + this.noOfCasualties +
	           "\nNumber of Bases: " + this.noOfBases;
	}
...
class Army extends Defence{
	...
	public String toString() {
	    return super.toString() +
	           "\nNumber of Tanks: " + this.noOfTanks +
	           "\nNumber of Guns: " + this.noOfGuns +
	           "\nNumber of Grenades: " + this.noOfGranads +
	           "\nNumber of Battalions: " + this.noOfBatallion;
	}
...
class Navy extends Defence{
	...
	public String toString() {
	    return super.toString() +
	           "\nNumber of Ships: " + this.noOfShips +
	           "\nNumber of Submarines: " + this.noOfSubmariens +
	           "\nNumber of Torpedoes: " + this.noOfTorpedoes;
	}	
}
...
class Air extends Defence {
    ...
    public String toString() {
        return super.toString() +
               "\nNumber of Missiles: " + this.noOfMissils +
               "\nNumber of Aircrafts: " + this.noOfAircrafts +
               "\nNumber of Squadrons: " + this.noOfSquadeon;
    }
...
//        air2.display();
        ...
        d5=new Navy();
        d5.attack();
        d5=new Army("General Singh", 100000, 250000000.0, 8, 500, 
              "New Delhi", "India", 120000, 300, 500, 20, 
              1000, 50000, 2000, 50);
        d5.attack();
