...
class Admin extends Employee{
	...
	public String toString() {
		return "\nId is : "+this.id+"\nName is : "+this.name+"\nSalary is : "+this.salary+"allowance is "+this.allowance;
	}
}
...
class SalesManager extends Employee{
	...
	public String toString() {
		return "\nId is : "+this.id+"\nName is : "+this.name+"\nSalary is : "+this.salary+"incentive is : "+this.incentive+"\ntarget is : "+this.target;
	}
...
class HR extends Employee{
	...
	public String toString() {
		return "\nId is : "+this.id+"\nName is : "+this.name+"\nSalary is : "+this.salary+"commission is : "+this.getCommission();
	}
}
//class hr ends hear
