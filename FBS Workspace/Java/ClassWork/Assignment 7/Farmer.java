abstract class Farmer {
	...
	public String toString() {
	    return "Farmer ID: " + this.farmerId +
	           "\nFarmer Name: " + this.farmerName +
	           "\nLand Area: " + this.landArea +
	           "\nCity: " + this.city +
	           "\nAnnual Income: " + this.annualIncoume +
	           "\nNumber of Equipments: " + this.noOfEquipments +
	           "\nInsurance Amount: " + this.insuarnceAmt;
	}
}
...
class DairyFarmer extends Farmer{
	...
	public String toString() {
	    return super.toString() +
	           "\nNumber of Cattles: " + this.noOfCattles +
	           "\nMilk Produced Per Day: " + this.milkProducePerDay +
	           "\nDairy Licence Number: " + this.dairyLincenceNo;
	}
}
...
class PoultyFarmer extends Farmer{
	...
	public String toString() {
	    return super.toString() +
	           "\nNumber of Chickens: " + this.noOfChikens +
	           "\nNumber of Sheds: " + this.noOfShads +
	           "\nEggs Produced Per Day: " + this.eggsProducePerDay +
	           "\nPoultry Farm Name: " + this.poultyFarmNm;
	}
}
...
class OrganicFarmer extends Farmer{
	...
	public String toString() {
	    return super.toString() +
	           "\nOrganicer ID: " + this.organicerId +
	           "\nCrop Type: " + this.cropType +
	           "\nNumber of Fertilizers Used: " + this.noOfFertilizerUsed;
	}
...
//        o2.display();
        ...
        f3=new OrganicFarmer(401, "Ganesh", 8.0, "Satara", 400000.0, 5, 90000.0, 111, "Wheat", 2);
        f3.calSubsidy();
