...
class SalaryAccount extends SavingsAccount {
    ...
    SalaryAccount(String accountHolderName, int accountNumber, double balance, String branchName, LocalDate dateOpened,
                  String accountType, boolean isActive, double minimumBalance, String currency,
                  double interestRate, int withdrawalsThisMonth, boolean hasDebitCard, boolean hasNetBanking, boolean isSalaryAccount,
                  String employerName, double monthlySalaryCredit, LocalDate lastSalaryDate,
    ...
    void setEmployerName(String employerName) { this.employerName = employerName; }

    double getMonthlySalaryCredit() { return monthlySalaryCredit; }
    void setMonthlySalaryCredit(double monthlySalaryCredit) { this.monthlySalaryCredit = monthlySalaryCredit; }

    LocalDate getLastSalaryDate() { return lastSalaryDate; }
    void setLastSalaryDate(LocalDate lastSalaryDate) { this.lastSalaryDate = lastSalaryDate; }

    boolean isZeroBalanceFeature() { return zeroBalanceFeature; }
    void setZeroBalanceFeature(boolean zeroBalanceFeature) { this.zeroBalanceFeature = zeroBalanceFeature; }

    boolean isTaxSavingEnabled() { return taxSavingEnabled; }
    void setTaxSavingEnabled(boolean taxSavingEnabled) { this.taxSavingEnabled = taxSavingEnabled; }
...
//        f2.display();
    	  BankAccount acc1 = new SavingsAccount(
                "Riya Sharma", 102, 70000, "Delhi",
                LocalDate.of(2021, 5, 10), "Savings", true, 5000, "INR",
                4.5, 2, true, true, true
            );
    	  acc1.withdraw(12345);
    	  acc1 = new CurrentAccount(
    	            "Neha Verma", 103, 150000, "Bangalore",
    	            LocalDate.of(2019, 3, 5), "Current", true, 10000, "INR",
    	            50000, "Retail", true, true, 3
    	        );
    	  acc1.withdraw(12345);
    	  acc1 =new SalaryAccount(
    	            "Rahul Kumar", 105, 60000, "Pune",
    	            LocalDate.of(2023, 2, 15), "Salary", true, 0, "INR",
    	            4.0, 1, true, true, true,
    	            "TechCorp Pvt Ltd", 60000, LocalDate.of(2023, 11, 1),
    	            true, false
    	        );
    	  acc1.withdraw(12345);
