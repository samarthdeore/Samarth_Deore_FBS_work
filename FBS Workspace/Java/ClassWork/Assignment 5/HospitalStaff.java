...
class HospitalStaff {
    ...
    HospitalStaff(String staffName, String staffID, String department, String position, int age, double salary, boolean isFullTime, LocalDate joiningDate) {
...
class Nurse extends HospitalStaff {
    ...
    Nurse(String staffName, String staffID, String department, String position, int age, double salary, boolean isFullTime, LocalDate joiningDate,
          int noOfPatientsAssigned, boolean isShifted, String shiftTiming, int yearsOfExperience, boolean isCertified) {
...
class Receptionist extends HospitalStaff {
    ...
    Receptionist(String staffName, String staffID, String department, String position, int age, double salary, boolean isFullTime, LocalDate joiningDate,
                 int noOfCallsHandled, int noOfAppointmentsScheduled, boolean isOnFrontDesk, boolean isTrained, String shiftTiming) {
        super(staffName, staffID, department, position, age, salary, isFullTime, joiningDate);
...
class Technician extends HospitalStaff {
    ...
    Technician(String staffName, String staffID, String department, String position, int age, double salary, boolean isFullTime, LocalDate joiningDate,
               String expertiseArea, int noOfMachinesHandled, boolean isCertified, int yearsOfExperience, boolean isOnDuty) {
        super(staffName, staffID, department, position, age, salary, isFullTime, joiningDate);
...
class TestHospitalStaff {
    public static void main(String[] args) {
        ...
        HospitalStaff hs2 = new HospitalStaff("Alice Johnson", "HS101", "Administration", "Manager", 40, 5000, true, LocalDate.of(2010, 6, 15));
        
        hs1.display();
        hs2.display();
        
        Nurse n1 = new Nurse();
        Nurse n2 = new Nurse("Mary Smith", "N202", "ICU", "Senior Nurse", 32, 3500, true, LocalDate.of(2015, 3, 10), 
                             20, true, "Morning", 10, true);
        
        n1.display();
        n2.display();
        
        Receptionist r1 = new Receptionist();
        Receptionist r2 = new Receptionist("John Doe", "R303", "Front Desk", "Receptionist", 28, 2500, true, LocalDate.of(2018, 5, 20),
                                           150, 50, true, true, "Evening");
        
        r1.display();
        r2.display();
        
        Technician t1 = new Technician();
        Technician t2 = new Technician("David Brown", "T404", "Lab", "Lab Technician", 35, 4000, true, LocalDate.of(2012, 11, 5),
                                       "Radiology", 5, true, 12, true);
